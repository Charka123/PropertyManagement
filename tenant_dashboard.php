...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'submit_request') {
    ...
    // Get property_id from lives table
...
<div class="main">
    <div class="page-header">
        ...
        <p>Manage your maintenance requests and property information</p>
    </div>
    ...
    <?php else: ?>
    <div class="no-property">⚠️ You are not assigned to a property yet. Contact your property owner.</div>
    <?php endif; ?>
    ...
    <div class="request-list">
        ...
        <div class="request-card">
            <div class="request-top">
                ...
                $urg_class = $urg === 'red' || $urg === 'high' ? 'badge-red' : ($urg === 'orange' || $urg === 'medium' ? 'badge-orange' : 'badge-green');
                ?>
                <span class="badge <?php echo $urg_class; ?>"><?php echo htmlspecialchars($req['urgency']); ?></span>
                <?php
